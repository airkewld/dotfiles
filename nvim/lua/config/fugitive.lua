...
vim.api.nvim_set_keymap('n', '<leader>push', [[<cmd>:G push<CR>]], { noremap = true, silent = true })
vim.api.nvim_set_keymap('n', '<leader>gco', [[<cmd>:G checkout .<CR>]], { noremap = true, silent = true })
vim.api.nvim_set_keymap('n', '<leader>pull', [[<cmd>:G pull<CR>]], { noremap = true, silent = true })
